<template>
    <section class="healthy_food">
        <div class="healthy_food_bg" :style="{ backgroundImage: `url(${healthyFoodBg})` }"></div>
        <div class="container">
            ...
            <div class="row">
                <div class="col-xl-6">
                    <div class="healthy_food_text">
                        <p>
                            Lorem ipsum dolor sit amet nsectetur cing elit. Suspe ndisse suscipit sagittis leo sit
...
<script setup>
// Images
import healthyFoodBg from '@/assets/images/resources/helathy_food_bg.png'
